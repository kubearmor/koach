...
type ListenAlertRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListenAlertRequest) Reset() {
	*x = ListenAlertRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListenAlertRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListenAlertRequest) ProtoMessage() {}

func (x *ListenAlertRequest) ProtoReflect() protoreflect.Message {
	mi := &file_koach_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListenAlertRequest.ProtoReflect.Descriptor instead.
func (*ListenAlertRequest) Descriptor() ([]byte, []int) {
	return file_koach_proto_rawDescGZIP(), []int{3}
}

func (x *ListenAlertRequest) GetNamespaceId() string {
	if x != nil {
		return x.NamespaceId
	}
	return ""
...
func (x *ListenAlertRequest) GetPodId() string {
	if x != nil {
		return x.PodId
	}
	return ""
...
func (x *ListenAlertRequest) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
type ListenAlertResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Observability *ObservabilityData `protobuf:"bytes,3,opt,name=observability,proto3" json:"observability,omitempty"`
}

func (x *ListenAlertResponse) Reset() {
	*x = ListenAlertResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListenAlertResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListenAlertResponse) ProtoMessage() {}

func (x *ListenAlertResponse) ProtoReflect() protoreflect.Message {
	mi := &file_koach_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListenAlertResponse.ProtoReflect.Descriptor instead.
func (*ListenAlertResponse) Descriptor() ([]byte, []int) {
	return file_koach_proto_rawDescGZIP(), []int{4}
}

func (x *ListenAlertResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *ListenAlertResponse) GetSeverity() int32 {
	if x != nil {
		return x.Severity
	}
	return 0
...
func (x *ListenAlertResponse) GetObservability() *ObservabilityData {
	if x != nil {
...
var file_koach_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x71, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x41,
	0x6c, 0x65, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x15,
	...
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x22, 0x8b, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73,
	0x74, 0x65, 0x6e, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x3e, 0x0a, 0x0d, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x44, 0x61, 0x74, 0x61, 0x52, 0x0d, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x32, 0x8c, 0x01, 0x0a, 0x14, 0x4f, 0x62, 0x73, 0x65, 0x72,
	...
	,
}
...
var file_koach_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_koach_proto_goTypes = []interface{}{
	...
	(*ListenAlertRequest)(nil),  // 3: proto.ListenAlertRequest
	(*ListenAlertResponse)(nil), // 4: proto.ListenAlertResponse
}
var file_koach_proto_depIdxs = []int32{
	0, // 0: proto.GetResponse.data:type_name -> proto.ObservabilityData
	0, // 1: proto.ListenAlertResponse.observability:type_name -> proto.ObservabilityData
	1, // 2: proto.ObservabilityService.Get:input_type -> proto.GetRequest
	3, // 3: proto.ObservabilityService.ListenAlert:input_type -> proto.ListenAlertRequest
	2, // 4: proto.ObservabilityService.Get:output_type -> proto.GetResponse
	4, // 5: proto.ObservabilityService.ListenAlert:output_type -> proto.ListenAlertResponse
...
func file_koach_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_koach_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListenAlertRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_koach_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListenAlertResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
